...
> **Validation numérique (13/06, vs TFLite de référence, même entrée)** —
> grille complète des précisions (erreur moyenne absolue) :
>
...
Stratégie de quantization (cf. ../RESEARCH.md) : `pcq` ou `int16` d'emblée —
l'exemple Radxa documente que l'uint8 naïf dégrade la précision. Si la
