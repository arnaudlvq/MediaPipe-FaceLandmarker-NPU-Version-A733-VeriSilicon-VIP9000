...
{
    vnn_ReleaseFaceLandmarksDetector( graph, TRUE );
...
{
    return vnn_PostProcessFaceLandmarksDetector( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessFaceLandmarksDetector( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateFaceLandmarksDetector( data_file_name, NULL,
