...
static void _load_input_meta()
{
    ...
    input_meta_tab[0].image.scale[0] = 0.0039216;
    input_meta_tab[0].image.scale[1] = 0.0039216;
    input_meta_tab[0].image.scale[2] = 0.0039216;
...
vsi_status vnn_PreProcessFaceLandmarksDetector
    (
    vsi_nn_graph_t *graph,
    const char **inputs,
    uint32_t input_num
