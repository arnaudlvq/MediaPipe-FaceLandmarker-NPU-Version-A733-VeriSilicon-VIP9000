...
#include "vnn_facelandmarksdetector.h"
...
vsi_nn_graph_t * vnn_CreateFaceLandmarksDetector
    (
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.dtype.fl = 21;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
    NEW_NORM_TENSOR(norm_tensor[3], attr, VSI_NN_TYPE_INT16);
...
error:
    ...
    vnn_ReleaseFaceLandmarksDetector( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateFaceLandmarksDetector() */

void vnn_ReleaseFaceLandmarksDetector
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
...
} /* vsi_nn_ReleaseFaceLandmarksDetector() */
