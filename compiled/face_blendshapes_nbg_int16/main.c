...
{
    vnn_ReleaseFaceBlendshapes( graph, TRUE );
...
{
    return vnn_PostProcessFaceBlendshapes( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessFaceBlendshapes( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateFaceBlendshapes( data_file_name, NULL,
