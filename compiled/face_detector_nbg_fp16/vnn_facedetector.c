...
vsi_nn_graph_t * vnn_CreateFaceDetector
    (
...
error:
    ...
    vnn_ReleaseFaceDetector( graph, release_ctx );

    return NULL;
} /* vsi_nn_CreateFaceDetector() */

void vnn_ReleaseFaceDetector
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
