...
{
    vnn_ReleaseFaceDetector( graph, TRUE );
...
{
    return vnn_PostProcessFaceDetector( graph );
}
    ...
    )
{
    ...
    return vnn_PreProcessFaceDetector( graph, inputs, input_num );
}
    ...
    )
{
    ...
    tmsStart = get_perf_count();
    graph = vnn_CreateFaceDetector( data_file_name, NULL,
